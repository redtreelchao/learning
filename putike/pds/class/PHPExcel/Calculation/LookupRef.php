...
class PHPExcel_Calculation_LookupRef {
	...
	public static function EVALUATE($value=Null, PHPExcel_Cell $pCell = null) {
		$formula	= PHPExcel_Calculation_Functions::flattenSingleValue($value);
        return PHPExcel_Calculation::_unwrapResult(PHPExcel_Calculation::getInstance()->_calculateFormulaValue("=".$formula, NULL, $pCell));
	}
