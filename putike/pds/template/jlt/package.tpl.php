...
<head>
    ...
    <title>PUTIKE &rsaquo; 深捷旅服务包列表</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">深捷旅服务包列表</h1>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo BASE_URL; ?>jlt.php?method=package&status=1">显示已关联</a></li>
                                <li><a href="<?php echo BASE_URL; ?>jlt.php?method=package&status=0">显示未关联</a></li>
                            </ul>
                        </div>
                        <!-- end filter -->
    ...
    function bind(code){
        ...
        $("#bind-search .modal-footer .btn-primary").unbind("click").bind("click", function(){
            ...
            //console.log(code);
            $.post("<?php echo BASE_URL; ?>jlt.php?method=package", {code:code,bind:bind}, function(data){
                if (data.s == 0) {
    ...
    function unbind(code, btn){
        ...
        $.post("<?php echo BASE_URL; ?>jlt.php?method=package", {code:code,bind:0}, function(data){
