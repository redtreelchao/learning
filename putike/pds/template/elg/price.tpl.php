...
<head>
    ...
    <title>PUTIKE &rsaquo; 深圳捷旅报价与房态</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">深捷旅报价与房态</h1>

                <form class="form-inline" action="<?php echo BASE_URL; ?>jlt.php" method="GET" style="padding-bottom:10px; line-height:40px;">
                    ...
                    <div class="form-group">
                        ...
                        <select id="room" name="room" class="form-control" style="min-width:200px;">
                            ...
                            if (isset($rooms)) {
                                foreach($rooms as $r) {
                            ?>
                            <option <?php echo $r['room'] == $room ? 'selected="selected"' : ''; ?> value="<?php echo $r['room']; ?>"><?php echo $r['roomname']; ?></option>
                            <?php
                                }
                            }
                            ?>
    ...
    $(function(){
        ...
        $("#hotel").change(function(){
            var hotel = $(this).val();
            $.get("<?php echo BASE_URL; ?>jlt.php", {id:hotel,method:"room"}, function(data){
                if (data.s == 0){
                    var room = $("#room");
                    room.html("<option value=\"\">选择房型..</option>");
                    for(x in data.rs){
                        room.append("<option value=\""+data.rs[x].room+"\">"+data.rs[x].roomname+"("+data.rs[x].bedname+")</option>");
                    }
