...
<head>
    ...
    <title>PUTIKE &rsaquo; 艺龙国家/城市列表</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">艺龙<?php echo empty($country) ? '国家列表' : '城市列表 <small>'.$country['name'].'</small>'; ?></h1>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php if(!empty($country)) echo '<li><a href="'.BASE_URL.'elg.php?method=city">返回</a></li>'; ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="md-nowrap">
                                    ...
                                    <a class="btn btn-sm btn-default" href="<?php echo BASE_URL; ?>elg.php?method=city&country=<?php echo $v['code']; ?>"><span class="glyphicon glyphicon-list hidden-md"></span><span class="hidden-xs hidden-sm"> 查看</span></a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?>
    ...
    function refresh(){
        ...
        di.slideDown(300);
        $.post("<?php echo BASE_URL; ?>elg.php?method=city", {refresh:1, type:'<?php echo empty($country) ? 'country' : 'city'; ?>', code:'<?php echo empty($country) ? 0 : $country['code']; ?>'}, function(data){
            if (data.s == 0){
