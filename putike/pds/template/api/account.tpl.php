...
<head>
    ...
    <title>PUTIKE &rsaquo; API账户管理</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">API账户管理</h1>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td title="<?php echo $v['id']; ?>"><?php echo $v['orgname']; ?></td>
                                <td class="f12"><?php echo $v['appid']; ?></td>
                                <td class="f12"><?php echo substr($v['appsecret'], 0, 2).str_repeat('*', 26).substr($v['appsecret'], -6); ?></td>
                                <td>
                                    <?php if($v['push']) { ?>
                                    <span class="label label-primary">已设置</span>
                                    <?php }else{ ?>
