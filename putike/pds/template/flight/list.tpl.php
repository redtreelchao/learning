...
<head>
    ...
    <title>PUTIKE &rsaquo; 航班列表</title>
...
<body>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo BASE_URL; ?>flight.php?method=new">添加新航班</a></li>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="row-<?php echo $v['id']; ?>">
                                ...
                                <td title="ID:<?php echo $v['id']; ?>"><?php echo $v['code']; if ($v['leg']) echo "-{$v['leg']}"; ?></td>
                                <td><abbr title="<?php echo $v['depart']; ?>"><?php echo $v['depart_airport']; ?></abbr></td>
                                <td><abbr title="<?php echo $v['arrive']; ?>"><?php echo $v['arrive_airport']; ?></abbr></td>
                                <td><?php echo $v['takeoff'], '--', $v['landing']; ?></td>
                                <td><?php echo $v['company']; ?></td>
                                <td class="md-nowrap">
                                    <a href="<?php echo BASE_URL; ?>flight.php?method=edit&id=<?php echo $v['id']; ?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil hidden-md"></span><span class="hidden-xs hidden-sm"> 编辑</span></a>
    ...
    <script>
    function del(id){
        $.post("<?php echo BASE_URL; ?>flight.php?method=del", {id:id}, function(data){
            if(data.s == 0){
