...
<head>
    ...
    <title>PUTIKE &rsaquo; 港捷旅报价与房态</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">港捷旅报价与房态</h1>

                <form class="form-inline" action="<?php echo BASE_URL; ?>cnb.php" method="GET" style="padding-bottom:10px; line-height:40px;">
    ...
    $(function(){
        ...
        $("#hotel").change(function(){
            var hotel = $(this).val();
            $.get("<?php echo BASE_URL; ?>cnb.php", {id:hotel,method:"room"}, function(data){
                if (data.s == 0){
                    var room = $("#room");
