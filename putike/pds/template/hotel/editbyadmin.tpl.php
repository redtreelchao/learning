                ...
                <form class="row" id="form" role="form">
                    ...
                    <div class="col-md-8 col-lg-9 form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="name" name="name" class="form-control" placeholder="中文名" value="<?php echo $data['name']; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="en" class="form-control" placeholder="外文名" value="<?php echo $data['en']; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="tel" name="tel" class="form-control" placeholder="(86)021-88888888" value="<?php echo $data['tel']; ?>"  />
                            </div>
                        </div>
