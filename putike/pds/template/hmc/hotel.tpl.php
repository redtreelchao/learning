...
<head>
    ...
    <title>PUTIKE &rsaquo; HMC酒店列表</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">HMC酒店列表</h1>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo BASE_URL; ?>hmc.php?method=hotel&status=1">显示已关联</a></li>
                                <li><a href="<?php echo BASE_URL; ?>hmc.php?method=hotel&status=0">显示未关联</a></li>
                            </ul>
                        </div>
                        <!-- end filter -->
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="md-nowrap">
                                    <a class="btn btn-sm btn-default" href="<?php echo BASE_URL; ?>hotel.php?method=new&sup=hmc&code=<?php echo $v['id']; ?>"><span class="glyphicon glyphicon-log-in hidden-md"></span><span class="hidden-xs hidden-sm"> 导入</span></a>
                                    <a class="btn btn-sm btn-default" href="<?php echo BASE_URL; ?>hmc.php?method=room&id=<?php echo $v['id']; ?>"><span class="glyphicon glyphicon-th-list hidden-md"></span><span class="hidden-xs hidden-sm"> 房型</span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
