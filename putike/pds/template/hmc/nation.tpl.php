...
<head>
    ...
    <title>PUTIKE &rsaquo; HMC国籍列表</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header">HMC国籍列表</h1>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo BASE_URL; ?>hmc.php?method=nation&status=1">显示已关联</a></li>
                                <li><a href="<?php echo BASE_URL; ?>hmc.php?method=nation&status=0">显示未关联</a></li>
                            </ul>
                        </div>
                        <!-- end filter -->
    ...
    function refresh(){
        ...
        di.slideDown(300);
        $.post("<?php echo BASE_URL; ?>hmc.php?method=nation", {refresh:1}, function(data){
            if (data.s == 0){
    ...
    function bind(code){
        ...
        $("#bind-search .modal-footer .btn-primary").unbind("click").bind("click", function(){
            ...
            //console.log(code);
            $.post("<?php echo BASE_URL; ?>hmc.php?method=nation", {code:code,bind:bind}, function(data){
                if (data.s == 0) {
                    var label = $('<span class="label label-primary" data-toggle="tooltip" data-placement="top" title="">已关联</span>');
                    label.attr("title", name);
                    $("#row-"+code+" td:eq(3)").html(label);
                    $("#row-"+code+" td:eq(2)").find(".label").remove();
    ...
    function unbind(code, btn){
        ...
        $.post("<?php echo BASE_URL; ?>hmc.php?method=nation", {code:code,bind:0}, function(data){
        ...
        $.get("<?php echo BASE_URL; ?>nation.php", {keyword:'', bind:bind, page:page}, function(data){
            if (data.s == 0){
                ...
                if(data.rs.list.length > 0){
                    ...
                    ul.append("<div style='text-align:center; color:#999;'>未找到任何数据，请尝试其他关键词或<a href=\"<?php echo BASE_URL; ?>nation.php#new\" target=\"_blank\">添加</a></div>");
                }
