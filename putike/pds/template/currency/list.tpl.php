...
<body>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo BASE_URL; ?>currency.php?method=new">添加汇率</a></li>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="row-<?php echo $v['id']; ?>">
                                ...
                                <td title="ID:<?php echo $v['id']; ?>"><?php echo $v['code'];  ?></td>
                                <td><?php echo $v['rate'] ?></td>
                                <td><?php echo  sprintf("%.5f", $v['currency']); ?></td>
                                <td class="md-nowrap">
                                    <a href="<?php echo BASE_URL; ?>currency.php?method=edit&id=<?php echo $v['id']; ?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil hidden-md"></span><span class="hidden-xs hidden-sm"> 编辑</span></a>
    ...
    <script>
    function del(id){
        $.post("<?php echo BASE_URL; ?>currency.php?method=del", {id:id}, function(data){
            if(data.s == 0){
