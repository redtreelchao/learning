...
<head>
    ...
    <title>PUTIKE &rsaquo; 车辆列表</title>
...
<body>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo BASE_URL; ?>car.php?method=new">添加新车辆</a></li>
                            </ul>
                        </div>
                        <!-- end filter -->
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="row-<?php echo $v['id']; ?>">
                                ...
                                <td class="md-nowrap">
                                    <a href="<?php echo BASE_URL; ?>car.php?method=edit&id=<?php echo $v['id']; ?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil hidden-md"></span><span class="hidden-xs hidden-sm"> 编辑</span></a>
    ...
    <script>
    function del(id){
        $.post("<?php echo BASE_URL; ?>car.php?method=del", {id:id}, function(data){
            if(data.s == 0){
