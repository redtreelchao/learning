...
<head>
    ...
    <title>PUTIKE &rsaquo; <?php echo $id ? '编辑' : '添加'; ?>车辆信息</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header"><?php echo $id ? '编辑' : '添加'; ?>车辆信息</h1>
    ...
    function save(){
        ...
        $.post("<?php echo BASE_URL; ?>car.php?method=edit", postdata, function(data){
            if(data.s == 0){
                <?php if($data){ ?>
                alert("保存成功", "success");
                <?php }else{ ?>
                location.href = "<?php echo BASE_URL; ?>car.php?method=edit&id="+data.rs+"#success";
                <?php } ?>
            }else{
