...
<head>
    ...
    <title>PUTIKE &rsaquo; 机场信息</title>
...
<body>
                    ...
                    <form class="col-xs-4 col-sm-6 col-md-6 col-lg-8 form-inline" action="" method="GET" role="form">
                        ...
                        <div class="btn-group" style="margin:20px 0px; margin-right:10px;">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo BASE_URL; ?>airport.php?method=new">添加机场</a></li>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="row-<?php echo $v['code']; ?>">
                                ...
                                <td><?php echo $v['code4']; ?></td>
                                <td><?php echo $v['name']; ?></td>
                                <td><?php echo $v['city']; ?></td>
                                <td class="md-nowrap">
                                    <a href="<?php echo BASE_URL; ?>airport.php?method=edit&code=<?php echo $v['code']; ?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil hidden-md"></span><span class="hidden-xs hidden-sm"> 编辑</span></a>
                                    <a href="javascript:del('<?php echo $v['code']; ?>')" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash hidden-md"></span><span class="hidden-xs hidden-sm"> 删除</span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
    ...
    <script>
    function del(code){
        $.post("<?php echo BASE_URL; ?>airport.php?method=del", {code:code}, function(data){
            if(data.s == 0){
                $('#row-'+code).fadeOut(500, function(){ $(this).remove(); });
            }else{
                alert(data.err);
            }
        }, "json");
