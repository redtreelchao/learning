...
<head>
    ...
    <title>PUTIKE &rsaquo; <?php echo $data ? '编辑' : '添加'; ?>机场信息</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-11 col-sm-offset-1 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header"><?php echo $data ? '编辑' : '添加'; ?>机场信息</h1>
                ...
                <form class="row" id="form" role="form">
                    ...
                    <div class="col-md-8 col-lg-9 form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">机场代码</label>
                            <div class="col-sm-4">
                                <input type="text" name="code" class="form-control" placeholder="" <?php if($data) echo 'readonly'; ?> value="<?php echo $data['code']; ?>" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">机场4字码</label>
                            <div class="col-sm-4">
                                <input type="text" name="code4" class="form-control" placeholder="" value="<?php echo $data['code4']; ?>" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">机场名称</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="city" class="form-control ui-select">
                                    <option value="">请选择..</option>
                                    <?php foreach ($citys as $k => $v) { ?>
                                    <option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $data['city']) echo "selected"; ?>><?php echo $v['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
    ...
    function save(){
        ...
        $.post("<?php echo BASE_URL; ?>airport.php?method=edit", postdata, function(data){
            if(data.s == 0){
                <?php if($data){ ?>
                alert("保存成功", "success");
                <?php }else{ ?>
                location.href = "<?php echo BASE_URL; ?>airport.php?method=edit&code="+data.rs+"#success";
                <?php } ?>
            }else{
